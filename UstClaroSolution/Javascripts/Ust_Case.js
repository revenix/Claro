...
Ust_Case.Funcion = {
    ...
    onLoad_case: function (econtext) {
        ...
        if (type !== CRM_FORM_TYPE_UPDATE) {
            ...
            else if (tipoCasoCode == "003" && sarResponse == "864340000") // Aceptada) 
            {
            ...
            else if (tipoCasoCode == "004" && sarResponse == null && complaintPhase == "864340001") { //1st Instance
            ...
            else if (tipoCasoCode == "004" && sarResponse == "864340000" && complaintPhase != "864340002") // Aceptada
            {
            ...
            else if (tipoCasoCode == "004" && complaintPhase == "864340002") { // Appeal
            ...
            else if (tipoCasoCode == "004" && sarResponse == null && complaintPhase == "864340000") { //Averia
            ...
            else if (tipoCasoCode == "005") { //Queja OSIPTEL
            ...
            else if (tipoCasoCode == "007") { //Reclamo LDR
            ...
            else if (tipoCasoCode == "008") { //Denuncia Indecopi
            ...
            else if (tipoCasoCode == "009") { //Reclamo SAC
            ...
            ListCategory.some(function (valor, indice, array) {
                ...
                if (valor != null) {
                    ...
                    var XmlFecth = "<fetch version='1.0' output-format='xml-platform' mapping='logical' distinct='false'>" +
                        ...
                        "<filter type='and'>" +
                        "<condition attribute='" + valor[0].entityType + "id' operator='eq' uiname='' uitype='" + valor[0].entityType + "' value = '" + valor[0].id + "' />" +
                        "<condition attribute='ust_allowcontractsmandatory' operator='eq' value='1' />" +
                        "</filter >" +
                        "</entity >" +
                        "</fetch >";
